...
- 将当前完整排版保存为本机自定义模板，支持复用、恢复和删除
- 在文本框中选中部分字符后，可单独设置字体、字重、字号和颜色
- 工作台工具栏、舞台、焦点反馈和状态标记统一升级
- 支持黑色模式与白色模式，主题选择会保存在当前浏览器
- 浏览器本地保存与读取
- 项目 JSON 导入和导出
- 撤销与重做
...
`v1.12.0` 延续共享协议：网页、CLI 和 MCP 共用同一套项目校验、revision 与图层操作；文字图层左右中点自适应宽度，上下中点垂直缩放，拖动与右侧文本框共享同一换行状态。
