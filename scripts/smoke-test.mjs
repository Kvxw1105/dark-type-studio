...
assert(pkg.version === "1.10.0", "package.json 版本应为 1.10.0");
assert(js.includes('APP_VERSION = "1.10.0"'), "app.js 版本与 package.json 不一致");
...
assert(js.includes('id: "n"') && js.includes('id: "s"'), "缺少上下中点横向把手");
