...
assert(pkg.version === "1.11.0", "package.json 版本应为 1.11.0");
assert(js.includes('APP_VERSION = "1.11.0"'), "app.js 版本与 package.json 不一致");
...
assert(js.includes("horizontalWidthLimit"), "缺少横向宽度安全区");
assert(js.includes("fitHorizontalText"), "缺少横向文字自适应");
assert(js.includes('id: "n"') && js.includes('id: "s"') && js.includes('id: "w"') && js.includes('id: "e"'), "缺少四边中点缩放把手");
...
assert(landingHtml.includes('class="seal-trigger"'), "首页缺少朱印主交互");
assert(landingHtml.includes('href="./studio.html"'), "首页缺少工作台入口");
assert(landingJs.includes('is-activated'), "首页缺少朱印状态切换");
assert(landingCss.includes("prefers-reduced-motion"), "首页缺少减少动效降级");
